...
**ขั้นตอนการใช้งาน**:
1. **เลือกโหมดการฝึก**:
   - **ฝึกอ่านสี**: ฝึกแปลงค่าความต้านทาน ↔ สีแถบ ทีละแถบ
   - **ฝึกแบบปกติ**: อ่านค่าความต้านทานจากแถบสี หรือเลือกสีจากค่า
...
4. **เลือกแถบที่ต้องการฝึก** (สำหรับฝึกอ่านสี): เลือกแถบที่ต้องการฝึกเป็นพิเศษ
...
**Color Reading Practice** เป็นโหมดพิเศษสำหรับ **ฝึกอ่านสีโดยเฉพาะ**
