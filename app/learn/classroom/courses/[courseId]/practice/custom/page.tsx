...
export default function ClassroomCustomPracticePage() {
  ...
  const handleStartPractice = () => {
    ...
    if (settings.answerType === 'color_reading' && settings.colorReadingMode) {
      ...
      let url = `/learn/classroom/courses/${courseId}/practice/color-reading/${modeMap[settings.colorReadingMode]}?type=${settings.resistorType}${settings.colorReadingMode === 'color_to_value' || settings.colorReadingMode === 'mixed' ? '&answerType=multiple_choice' : ''}`;
    ...
    router.push(`/learn/classroom/courses/${courseId}/practice/custom/start?${queryParams.toString()}`);
  };
        ...
        <main className="container mx-auto px-4 py-4 sm:py-6 md:py-8 lg:px-8">
          ...
          <div className="mb-6 sm:mb-8 rounded-xl sm:rounded-2xl bg-white p-4 sm:p-6 md:p-8 shadow-xl">
            ...
            <div className="mb-6 sm:mb-8">
              ...
              <div className="grid gap-4 sm:gap-6 md:grid-cols-2">
                ...
                >
                  <div className="mb-4 flex items-center gap-3">
                    <div className={`flex h-12 w-12 items-center justify-center rounded-xl ${
                      settings.resistorType === 'FOUR_BAND' ? 'bg-blue-600' : 'bg-gray-100'
                    }`}>
                ...
                >
                  <div className="mb-4 flex items-center gap-3">
                    <div className={`flex h-12 w-12 items-center justify-center rounded-xl ${
                      settings.resistorType === 'FIVE_BAND' ? 'bg-blue-600' : 'bg-gray-100'
                    }`}>
                      <svg className="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z" />
                      </svg>
            ...
            <div className="mb-6 sm:mb-8">
              ...
              <div className="grid gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-4">
                ...
                >
                  <div className="mb-2 flex items-center gap-2">
                    <div className={`h-4 w-4 rounded-full border-2 ${
                      settings.answerType === 'multiple_choice' ? 'border-blue-600 bg-blue-600' : 'border-gray-300'
                    }`}></div>
                ...
                >
                  <div className="mb-2 flex items-center gap-2">
                    <div className={`h-4 w-4 rounded-full border-2 ${
                      settings.answerType === 'fill_in' ? 'border-blue-600 bg-blue-600' : 'border-gray-300'
                    }`}></div>
                ...
                >
                  <div className="mb-2 flex items-center gap-2">
                    <div className={`h-4 w-4 rounded-full border-2 ${
                      settings.answerType === 'color_selection' ? 'border-blue-600 bg-blue-600' : 'border-gray-300'
                    }`}></div>
            ...
            <div className="mb-6 sm:mb-8">
              ...
              <div className="grid gap-4 sm:gap-6 md:grid-cols-3">
                ...
                >
                  <div className="mb-3 flex items-center gap-2">
                    <div className={`h-4 w-4 rounded-full border-2 ${
                      settings.difficulty === 'medium' ? 'border-blue-600 bg-blue-600' : 'border-gray-300'
                    }`}></div>
              ...
              <div className="mb-6 sm:mb-8 rounded-xl sm:rounded-2xl bg-white p-4 sm:p-6 md:p-8 shadow-xl">
                ...
                <div className="grid gap-4 sm:gap-6 md:grid-cols-2">
                  ...
                  >
                    <div className="mb-3 flex items-center gap-2">
                      <div className={`h-4 w-4 rounded-full border-2 ${
                        settings.colorReadingMode === 'value_to_color_band_by_band' ? 'border-blue-600 bg-blue-600' : 'border-gray-300'
                      }`}></div>
                  ...
                  >
                    <div className="mb-3 flex items-center gap-2">
                      <div className={`h-4 w-4 rounded-full border-2 ${
                        settings.colorReadingMode === 'color_to_value' ? 'border-blue-600 bg-blue-600' : 'border-gray-300'
                      }`}></div>
            ...
            <div className="mb-6 sm:mb-8">
              <div className="mb-3 flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative h-8 w-16 rounded-full transition-colors ${
                    settings.hasQuestionLimit ? 'bg-blue-600' : 'bg-gray-300'
                  }`}
                >
              ...
              {!settings.hasQuestionLimit && (
                <div className="rounded-lg sm:rounded-xl border-2 border-dashed border-blue-300 bg-blue-50 p-3 sm:p-4 text-center">
                  <p className="text-sm sm:text-base font-semibold text-blue-700">โหมดฝึกฝนไม่จำกัด</p>
                  <p className="text-xs sm:text-sm text-blue-600">ฝึกฝนได้นานเท่าที่คุณต้องการ!</p>
                </div>
              )}
            </div>
            ...
            <div className="mb-6 sm:mb-8">
              <div className="mb-3 flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative h-8 w-16 rounded-full transition-colors ${
                    settings.hasCountdown ? 'bg-blue-600' : 'bg-gray-300'
              ...
              {settings.hasCountdown && (
                <div className="rounded-lg sm:rounded-xl border border-gray-200 bg-gradient-to-br from-blue-50 to-blue-100 p-4 sm:p-6">
                  ...
                  <div className="flex items-center gap-4 sm:gap-6">
                    ...
                    />
                    <div className="min-w-[80px] rounded-xl bg-white border-2 border-blue-500 px-4 py-2 text-center shadow-md">
                      <div className="text-xl sm:text-2xl font-bold text-blue-600">{settings.countdownTime}</div>
            ...
            <div className="mb-6 sm:mb-8">
              <div className="mb-3 flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative h-8 w-16 rounded-full transition-colors ${
                    settings.hasTimeLimit ? 'bg-blue-600' : 'bg-gray-300'
            ...
            {/* Summary */}
            <div className="mb-6 sm:mb-8 rounded-lg sm:rounded-xl border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-blue-100 p-4 sm:p-6">
