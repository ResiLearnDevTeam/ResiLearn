...
export default function SessionDetailPage() {
  ...
  const fetchSession = async () => {
    try {
      const response = await fetch(`/api/courses/${courseId}/practice/sessions?id=${sessionId}`);
      if (response.ok) {
        ...
        >
          <div className="text-center">
            ...
            <Link
              ...
              className="rounded-xl bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-3 text-white font-semibold hover:from-blue-600 hover:to-blue-700"
            >
              กลับไปโหมดฝึกฝน
            </Link>
          </div>
        ...
        <main className="container mx-auto px-4 py-4 sm:py-6 lg:px-8">
          ...
          <div className="mb-6 rounded-xl bg-white p-4 sm:p-6 shadow-lg">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600">{session.correctAnswers}/{session.totalQuestions}</div>
