...
async function main() {
  ...
  // ================= CONFIG =================
  const courseName = 'Electrical Basic Sec 1 2569'
  ...
  // ================= ANSWER SETS =================
  // เรียงตาม order ของ assignment: 0=ตัวเลือก, 1=Fill-in, 2=เลือกสี, 3=รวม(MC+FI), 4=รวม(FI+CS)
  // คะแนนเพิ่มขึ้นตามเวลา: order 0 (ต่ำสุด) → order 4 (สูงสุด)
  // กฎ: FOUR_BAND=ถูก, FIVE_BAND=ผิด
  const answerSets = [
    {
      title: 'แบบฝึกหัดอ่านค่าตัวต้านทาน (ตัวเลือก)',
      completedAt: new Date('2026-01-20T10:00:00.000Z'), // order 0 - วันที่เก่าที่สุด, คะแนนต่ำสุด (40%)
      answers: [
        {
          question: {
            id: 'mc_q1',
          ...
          isCorrect: true, // 2/5 = 40% (FOUR_BAND=ถูก)
    ...
    },
    {
      ...
      completedAt: new Date('2026-01-22T10:00:00.000Z'), // order 1 - คะแนน 50%
      answers: [
        {
          question: {
            id: 'fi_q1',
          ...
          isCorrect: true, // 3/5 = 60% (FOUR_BAND=ถูก)
    ...
    },
    {
      ...
      completedAt: new Date('2026-01-24T10:00:00.000Z'), // order 2 - คะแนน 60%
      answers: [
        {
          question: {
            id: 'cs_q1',
    ...
    },
    {
      ...
      completedAt: new Date('2026-01-26T10:00:00.000Z'), // order 3 - คะแนน 70%
      answers: [
        // จาก multiple_choice (5 ข้อ)
        {
          question: {
            id: 'mc_q1',
            bands: ['red', 'black', 'black', 'red'],
        ...
        // จาก fill_in (5 ข้อ) - ปรับ order เป็น 6-10, FIVE_BAND=ผิด
        {
          question: {
            id: 'fi_q1',
            bands: ['brown', 'black', 'red', 'gold'],
          ...
          isCorrect: true, // FOUR_BAND = ถูก
          timestamp: 1769536191000,
          userAnswer: '1kΩ ±5%',
        },
        {
          question: {
    ...
    },
    {
      ...
      completedAt: new Date('2026-01-28T10:00:00.000Z'), // order 4 - วันที่ใหม่ที่สุด, คะแนนสูงสุด (80%)
      answers: [
        // จาก fill_in (5 ข้อ) - FOUR_BAND=ถูก, FIVE_BAND=ผิด
        {
          question: {
            id: 'fi_q1',
            bands: ['brown', 'black', 'red', 'gold'],
        ...
        // จาก color_selection (5 ข้อ) - ปรับ order เป็น 6-10, FIVE_BAND=ผิด
        {
          question: {
            id: 'cs_q1',
            bands: ['brown', 'red', 'orange', 'gold'],
