...
function LevelLearnContent() {
  ...
  const lessons = [
          ...
          <div className="rounded-lg bg-green-50 p-6 border-2 border-green-200">
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div className="text-xs text-gray-500">From Digit Colors</div>
              </div>
    ...
    {
      title: 'Example 2: Green-Violet-Brown-Gold',
      description: 'Practice reading another resistor',
      content: (
        <div className="space-y-6">
          <div className="rounded-lg bg-teal-50 p-6 border-2 border-teal-200">
            <h3 className="text-xl font-bold text-teal-900 mb-4">Another Example</h3>
            
            <div className="mb-4">
              <ResistorDisplay 
                bands={['green', 'violet', 'brown', 'gold']}
                type="FOUR_BAND"
              />
            </div>
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <div className="font-semibold text-gray-900">Band 1: Green</div>
                  <div className="text-sm text-gray-600">First digit = 5</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <div className="font-semibold text-gray-900">Band 2: Violet</div>
                  <div className="text-sm text-gray-600">Second digit = 7</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <div className="font-semibold text-gray-900">Band 3: Brown</div>
                  <div className="text-sm text-gray-600">Multiplier = 10 (×10)</div>
                </div>
              </div>
            ...
            <div className="mt-4 p-4 rounded-lg bg-gradient-to-r from-teal-500 to-teal-600 text-white">
              <div className="text-sm font-semibold mb-1">Calculation:</div>
              <div className="text-2xl font-bold">
                57 × 10 = <strong>570Ω</strong>
              </div>
              <div className="text-sm mt-1">or <strong>570Ω ±5%</strong></div>
            </div>
          </div>
        </div>
      ),
    ...
    {
      title: 'Example 3: Orange-Orange-Black-Gold',
      description: 'One more example to master the concept',
      content: (
        <div className="space-y-6">
          <div className="rounded-lg bg-rose-50 p-6 border-2 border-rose-200">
            <h3 className="text-xl font-bold text-rose-900 mb-4">Final Example</h3>
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <div className="font-semibold text-gray-900">Band 1: Orange</div>
                  <div className="text-sm text-gray-600">First digit = 3</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <div className="font-semibold text-gray-900">Band 2: Orange</div>
                  <div className="text-sm text-gray-600">Second digit = 3</div>
                </div>
              </div>
              
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-lg bg-black flex items-center justify-center text-white font-bold text-xl">
                  1
                </div>
                <div className="flex-1">
                  <div className="font-semibold text-gray-900">Band 3: Black</div>
                  <div className="text-sm text-gray-600">Multiplier = 1 (×1)</div>
                </div>
              </div>
            ...
            <div className="mt-4 p-4 rounded-lg bg-gradient-to-r from-rose-500 to-rose-600 text-white">
              <div className="text-sm font-semibold mb-1">Calculation:</div>
              <div className="text-2xl font-bold">
                33 × 1 = <strong>33Ω</strong>
              </div>
              <div className="text-sm mt-1">or <strong>33Ω ±5%</strong></div>
            </div>
          </div>
        </div>
      ),
