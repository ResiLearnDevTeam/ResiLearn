...
function ValueToColorFullContent() {
  ...
  useEffect(() => {
    if (bandIndex === null) {
      ...
      window.location.href = `/learn/classroom/courses/${courseId}/practice/quick/select`;
      return;
    }
            ...
            <div className="mb-4 text-center">
              <h2 className="mb-3 text-lg sm:text-xl font-bold text-gray-900">
                เลือกสีที่ถูกต้องสำหรับ {getBandLabel(bandIndex, resistorType)}
                  ...
                  <div className="inline-block rounded-lg bg-gradient-to-r from-blue-100 to-blue-50 px-4 py-2 border-2 border-blue-300">
                    <p className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-blue-700 tracking-tight">
