...
export default function ColorReadingPage() {
  ...
  const handleStartPractice = () => {
    ...
    if (selectedPracticeType === 'comprehensive') {
      ...
      router.push(`/learn/classroom/courses/${courseId}/practice/color-reading/mixed?type=${selectedType}`);
      return;
    }
    ...
    let url = `/learn/classroom/courses/${courseId}/practice/color-reading/${modeMap[selectedMode]}?type=${selectedType}`;
            ...
            <div className="mb-6 sm:mb-8 rounded-xl sm:rounded-2xl bg-white p-4 sm:p-6 md:p-8 shadow-xl">
              ...
              <div className="grid gap-4 sm:gap-6 md:grid-cols-2">
                ...
                >
                  <div className="mb-3 flex items-center gap-2">
                    <div className={`h-4 w-4 rounded-full border-2 ${
                      selectedMode === 'value_to_color_full' ? 'border-blue-600 bg-blue-600' : 'border-gray-300'
                    }`}></div>
                ...
                >
                  <div className="mb-3 flex items-center gap-2">
                    <div className={`h-4 w-4 rounded-full border-2 ${
                      selectedMode === 'value_to_color_band_by_band' ? 'border-blue-600 bg-blue-600' : 'border-gray-300'
                    }`}></div>
                ...
                >
                  <div className="mb-3 flex items-center gap-2">
                    <div className={`h-4 w-4 rounded-full border-2 ${
                      selectedMode === 'color_to_value' ? 'border-blue-600 bg-blue-600' : 'border-gray-300'
                    }`}></div>
                ...
                >
                  <div className="mb-3 flex items-center gap-2">
                    <div className={`h-4 w-4 rounded-full border-2 ${
                      selectedMode === 'mixed' ? 'border-blue-600 bg-blue-600' : 'border-gray-300'
                    }`}></div>
